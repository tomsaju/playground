...
/**
 * Created by tom.saju on 11/1/2017.
 */
...
public class HorizonView extends View {
    ...
    public HorizonView(Context context, AttributeSet ats,int defaultStyle){
        super(context,ats,defaultStyle);
        initCompassView();
    }

    public HorizonView(Context context,AttributeSet ats){
        super(context,ats);
        initCompassView();
    }
    ...
    private void initCompassView() {
        ...
        grounHorizonColorTo = r.getColor(R.color.horizon_ground_to);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        LinearGradient groundShader = new LinearGradient(center.x,
                innerBoundingBox.top, center.x, innerBoundingBox.bottom,
                groundHorizonColorFrom, grounHorizonColorTo, Shader.TileMode.CLAMP);
